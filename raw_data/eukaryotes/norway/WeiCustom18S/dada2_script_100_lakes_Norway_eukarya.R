...
fastq_dir <- "/cluster/projects/nn9745k/02_results/03_hundred_lakes_norway/eukaryota/AdaptersRemoved"  # fastq directory with the samples we are using
path_out = "/cluster/projects/nn9745k/02_results/03_hundred_lakes_norway/eukaryota"
...
out = filterAndTrim(fns_R1, filt_R1, fns_R2, filt_R2,
	  truncLen=c(270,190), maxN=0, maxEE=c(2,2),
	  truncQ=20, rm.phix=TRUE, compress=TRUE,
